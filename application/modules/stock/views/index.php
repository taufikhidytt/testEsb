...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
            <a href="<?= base_url('stock/add')?>" class="btn btn-success btn-sm">
            ...
            <table class="table table-bordered table-responsive-lg table-striped text-center" id="hero">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $dt->qty;?></td>
                        <td>
                            <form action="<?= base_url('stock/del')?>" method="post" class="d-inline">
                                <input type="hidden" name="id" value="<?= $dt->id_stock?>">
