...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
            <a href="<?= base_url('item_type/add')?>" class="btn btn-success btn-sm">
            ...
            <table class="table table-bordered table-responsive-lg table-striped text-center" id="hero">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('item_type/update/'.$dt->id_type)?>" class="btn btn-primary btn-sm">
                                <i class="fa fa-pencil-alt"></i>
                            </a>  |
                            <form action="<?= base_url('item_type/del')?>" method="post" class="d-inline">
                                <input type="hidden" name="id" value="<?= $dt->id_type?>">
